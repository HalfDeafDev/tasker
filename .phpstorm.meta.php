...
'dashboard','definitions.list','definitions.form','definitions.create','definitions.show',
'definitions.instantiate','dev.props','instances.create',
'instances.list','instances.create.one-off','instances.show','home','component.create.description','storage.local','storage.local.upload',);
